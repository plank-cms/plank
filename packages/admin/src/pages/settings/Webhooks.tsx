    ...
    <div>
      ...
      <Dialog open={createOpen} onOpenChange={(o) => { if (!o) { setCreateOpen(false); setForm(EMPTY_FORM) } }}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            <Button variant="outline" type="button" onClick={() => { setCreateOpen(false); setForm(EMPTY_FORM) }}>
              Cancel
            </Button>
            <Button
              type="submit"
      ...
      <Dialog open={!!deleteWebhook} onOpenChange={(o) => { if (!o) setDeleteWebhook(null) }}>
        <DialogContent className="sm:max-w-sm">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <span className="font-medium text-foreground">{deleteWebhook?.name}</span>?
